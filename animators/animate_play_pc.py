...
class VideoMobject(ImageMobject):
    def __init__(self, filename=None, imageops=None, speed=1.0, loop=False, **kwargs):
        print("[animate_play_pc] Initializing VideoMobject for", filename)
        ...
        if not self.status.videoObject.isOpened():
            print(f"[animate_play_pc] Error: Could not open video file {filename}")
            return
        ...
        if ret:
            ...
            print("[animate_play_pc] VideoMobject initialized successfully")
        else:
            print(f"[animate_play_pc] Error: Could not read first frame from video file {filename}")
...
class AnimatePlayPC(Scene):
    def __init__(self, **kwargs):
        print("[animate_play_pc] Entering __init__")
        ...
        print(f"[animate_play_pc] Loading animation data from: {animation_data_path}")
        ...
        print(f"[animate_play_pc] formation_name: {self.formation_name}")
        print("[animate_play_pc] Exiting __init__")

    def construct(self):
        print("[animate_play_pc] Entering construct")
    ...
    def play_whistle_sound(self):
        ...
        if os.path.exists(whistle_sound_path):
            ...
            print(f"[animate_play_pc] Added whistle sound from {whistle_sound_path}")
        else:
            print(f"[animate_play_pc] Whistle sound file not found: {whistle_sound_path}")
    ...
    def play_chase_sound(self):
        ...
        print("[animate_play_pc] play_chase_sound called (first time in this segment)")
        ...
        if os.path.exists(chase_sound_path):
            ...
            print(f"[animate_play_pc] Added chase sound from {chase_sound_path}")
        else:
            print(f"[animate_play_pc] Chase sound file not found: {chase_sound_path}")
    ...
    def play_protection_sound(self):
        ...
        print("[animate_play_pc] play_protection_sound called (first time in this segment)")
        ...
        if os.path.exists(protection_sound_path):
            ...
            print(f"[animate_play_pc] Added protection sound from {protection_sound_path}")
        else:
            print(f"[animate_play_pc] Protection sound file not found: {protection_sound_path}")

    def preload_audio_durations(self):
        print("[animate_play_pc] Entering preload_audio_durations")
        ...
        print(f"[animate_play_pc] Loading audio durations from: {audio_script_path}")
        with open(audio_script_path, 'r') as f:
            self.audio_durations = json.load(f)
        print(f"[animate_play_pc] Loaded {len(self.audio_durations.get('segments', []))} segments")
        print("[animate_play_pc] Exiting preload_audio_durations")

    def play_segment(self, segment_name, players, field=None):
        print(f"[animate_play_pc] Entering play_segment: '{segment_name}'")
    ...
    def play_audio(self, segment_name):
        ...
        if os.path.exists(audio_path):
            ...
            print(f"[animate_play_pc] Added audio for '{segment_name}' from {audio_path}")
            ...
            print(f"[animate_play_pc] Audio file not found for {segment_name}: {audio_path}")
            return 0

    def setup_field(self):
        print("[animate_play_pc] Entering setup_field")
        ...
        if not os.path.exists(field_img):
            print(f"[animate_play_pc] Field image not found: {field_img}. Using placeholder.")
            field = Rectangle(
        ...
        print(f"[animate_play_pc] yard_scale = {yard_scale}")
        ...
        print("[animate_play_pc] Exiting setup_field")

        return field, yard_scale, yard_to_point

    def setup_players(self, yard_to_point, yard_scale):
        print("[animate_play_pc] Entering setup_players")
        ...
        if "fb" in formation:
            ...
            print("[animate_play_pc] DEBUG: Created FB player")
        else:
            print("[animate_play_pc] DEBUG: No FB in formation")
        ...
        if "te_t" in formation:
            ...
            print("[animate_play_pc] DEBUG: Created TE_T player")
        else:
            print("[animate_play_pc] DEBUG: No TE_T in formation")
        ...
        print(f"[animate_play_pc] DEBUG: Final players_dict keys: {list(players_dict.keys())}")
        print("[animate_play_pc] Exiting setup_players")
        return players_dict

    def create_football(self, point, scale):
        print("[animate_play_pc] create_football called")
        football = Circle(
            radius=scale*0.6,
            color="#D37F00",
            fill_opacity=1,
    ...
    def create_route_path(self, path_points, route_style="curved", sharp_points=None):
        ...
        print(f"[animate_play_pc] create_route_path with style {route_style}, {len(path_points)} points")
        path = VMobject()

        if len(path_points) < 2:
            print(
                f"[animate_play_pc] Warning: Insufficient path points ({len(path_points)}). Creating default path.")
        ...
        if path.has_no_points():
            print("[animate_play_pc] Warning: Created path has no points. Creating fallback path.")
    ...
    def create_throw_indicator(self, start_pos, end_pos):
        ...
        print("[animate_play_pc] create_throw_indicator called")
    ...
    def create_protection_indicator(self, path_points):
        ...
        print("[animate_play_pc] create_protection_indicator called")
        if len(path_points) < 2:
            return VGroup()
    ...
    def formation_intro(self, players, field, audio_duration):
        print("[animate_play_pc] Entering formation_intro")
        ...
        print(f"[animate_play_pc] Highlighting {len(key_players)} players in formation intro")
        ...
        print("[animate_play_pc] Exiting formation_intro")

    def snap_animation(self, players, audio_duration):
        print("[animate_play_pc] Entering snap_animation")
        ...
        if remaining > 0:
            self.wait(remaining)
        print("[animate_play_pc] Exiting snap_animation")

    def offensive_line_protection(self, players, audio_duration):
        print("[animate_play_pc] Entering offensive_line_protection")
        ...
        print("[animate_play_pc] Exiting offensive_line_protection")

    def player_route_animation(self, players, segment_name, audio_duration):
        print(f"[animate_play_pc] Entering player_route_animation for {segment_name}")
        ...
        print(f"[animate_play_pc] DEBUG: Processing route for player: '{player_pos}', segment: '{segment_name}'")
        ...
        if player_pos == "te":
            ...
            if "fb" in players and len(players["fb"]) > 0:
                ...
                print(
                    f"[animate_play_pc] DEBUG: Found FB player with route data: {route_data.get('label', 'No label')}")
            else:
                print("[animate_play_pc] DEBUG: FB player not found")
                return
            ...
            if "te_t" in players and len(players["te_t"]) > 0:
                ...
                print(
                    f"[animate_play_pc] DEBUG: Found TE_T player with route data: {route_data.get('label', 'No label')}")
            else:
                print("[animate_play_pc] DEBUG: TE_T player not found")
                return
        else:
            print(f"[animate_play_pc] DEBUG: Unknown player position: {player_pos}")
            return
        ...
        if route_type == "protection":
            ...
            print(
                f"[animate_play_pc] DEBUG: Playing protection sound for {player_pos} (route type: {route_type})")
        ...
        # --- FIX: deterministic sum ---
        # Compute total animation time based on run_times used
        self.play(Write(route_label, run_time=0.5))

        # Main route segments
        num_segments = len(path_segments)
        segment_draw_time = 0.5 / num_segments if num_segments else 0
        segment_move_time = 3.0 / num_segments if num_segments else 0

        total_animation_time = 0.5  # route_label
        ...
        total_animation_time += num_segments * (segment_draw_time + segment_move_time)  # = 0.5 + 3.0 = 3.5
        ...
        if original_audio_duration > 0:
            time_to_wait = max(0, original_audio_duration - total_animation_time)
            if time_to_wait > 0:
                self.wait(time_to_wait)

            self.wait(0.5)

            video_remaining = max(0, audio_duration - (total_animation_time + time_to_wait + 0.5))
        else:
            self.wait(2)
            total_animation_time += 2
            video_remaining = max(0, audio_duration - total_animation_time)
        ...
        if video_remaining > 0 and "type" in route_data:
            ...
            if os.path.exists(video_path):
                try:
                    ...
                    print(f"[animate_play_pc] Error loading video: {e}")
                    if video_remaining > 0:
                        self.wait(video_remaining)
            else:
                print(f"[animate_play_pc] Video file not found: {video_path}")
                if video_remaining > 0:
                    self.wait(video_remaining)
        ...
        self.play(*fade_outs)
        print(f"[animate_play_pc] Exiting player_route_animation for {segment_name}")

    def qb_read_animation(self, players, segment_name, audio_duration):
        print(f"[animate_play_pc] Entering qb_read_animation for {segment_name}")
        read_target_mapping = {
            "z": "wr_z",
            "te": "te",
            "x": "wr_x"
        ...
        if not player_pos:
            print(f"[animate_play_pc] DEBUG: Unknown read target: {read_target}")
            return
        ...
        if not target_read:
            print(f"[animate_play_pc] DEBUG: No read progression found for player: {player_pos}")
            return
        ...
        if player_key not in players:
            print(f"[animate_play_pc] DEBUG: Player key '{player_key}' not found in players dictionary")
            return
        ...
        print(f"[animate_play_pc] Exiting qb_read_animation for {segment_name}")

    def passing_options_animation(self, players, segment_name, audio_duration):
        print(f"[animate_play_pc] Entering passing_options_animation for {segment_name}")
        ...
        if animations:
            ...
            total_time += max(0.7, 0.7)  # both have run_time 0.7, so max=0.7
        ...
        self.play(*fade_outs)
        print(f"[animate_play_pc] Exiting passing_options_animation for {segment_name}")